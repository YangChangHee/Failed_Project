...
from core.function2 import train
from core.function2 import validate
...
# python tools/new_F_module.py --cfg experiments/h36m/hrnet/new_F_w32_256x192_adam_lr1e-3.yaml
