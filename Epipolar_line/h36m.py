...
import time
from dataset.JointsDataset_h36m import JointsDataset
...
class h36mDataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.last_acids=0
        self.last_subis=0
        self.Mode_12 = cfg.DATASET.MODE_12
    ...
    ### w32_256x192_adam_lr1e-3.yaml subject 1 5 6 7 8로 수정하고 훈련하기
    ...
    def _get_db(self):
        if self.is_train or self.use_gt_bbox:
            ...
            gt_db=self._load_coco_person_detection_result()
        return gt_db
    ...
    def _load_coco_keypoint_annotations(self):
        ...
        for n,index in enumerate(tqdm(self.image_set_index)):
            ...
            if self.Mode_12==True:
                if (camids == 1) or (camids ==2):
                    gt_db.extend(self._load_coco_keypoint_annotation_kernel(index, keypoints_data))
            else:
                gt_db.extend(self._load_coco_keypoint_annotation_kernel(index, keypoints_data))
        return gt_db
